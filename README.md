[![Build Status](https://travis-ci.org/nantesnlp/uima-tokens-regex.svg?branch=master)](https://travis-ci.org/nantesnlp/uima-tokens-regex)  [ ![Download](https://api.bintray.com/packages/pompadour/maven/uima-tokens-regex/images/download.svg) ](https://bintray.com/pompadour/maven/uima-tokens-regex/_latestVersion) 
